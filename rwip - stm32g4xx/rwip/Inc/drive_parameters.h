...
#define MAX_APPLICATION_SPEED_RPM       3430 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT         15500
#define PID_TORQUE_KI_DEFAULT         250
#define PID_TORQUE_KD_DEFAULT         3500
#define PID_FLUX_KP_DEFAULT           520
#define PID_FLUX_KI_DEFAULT           260
...
// #define PID_SPEED_KI_DEFAULT          250/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KD_DEFAULT          2500/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/

// #define PID_SPEED_KP_DEFAULT          12000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KI_DEFAULT          250/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KD_DEFAULT          1500/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/


//With power supply -- WORKED THREE TIMES 
// #define PID_SPEED_KP_DEFAULT          14000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KI_DEFAULT          250/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KD_DEFAULT          2500/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/

//With power supply -- WORKED THREE TIMES - with new LAST 
#define PID_SPEED_KP_DEFAULT          5500/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          50/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KD_DEFAULT          5000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
//#define PID_SPEED_KD_DEFAULT          0/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/


// Letzter funktionierder Zustand
// #define PID_SPEED_KP_DEFAULT          14000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KI_DEFAULT          350/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KD_DEFAULT          0/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/

// // //For stabilize up
// #define PID_SPEED_KP_DEFAULT          14000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KI_DEFAULT          350/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
// #define PID_SPEED_KD_DEFAULT          4000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM       1496
...
#define FINAL_I_ALIGNMENT               12016 /*!< s16A */

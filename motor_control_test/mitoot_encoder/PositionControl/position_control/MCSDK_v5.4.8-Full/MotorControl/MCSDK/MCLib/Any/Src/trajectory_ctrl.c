...
void TC_PositionRegulation(PosCtrl_Handle_t *pHandle)
{
  ...
  if (pHandle->PositionControlRegulation == ENABLE)
  {
    ...
    //float currentPositionRad = wMecAngle  / RADTOS16;
    //int deg = currentPositionRad*180/M_PI;
    //


    //float currentPositionRad = motorDegrees/180 * M_PI;
    //wMecAngle = currentPositionRad * RADTOS16;
    //printf("MecAngle %d\r\n",wMecAngle);

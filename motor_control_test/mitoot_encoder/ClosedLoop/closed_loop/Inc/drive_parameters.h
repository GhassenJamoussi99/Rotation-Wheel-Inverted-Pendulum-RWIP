...
#define PID_SPEED_KP_DEFAULT          2845/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          374/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define FINAL_I_ALIGNMENT               12032 /*!< s16A */

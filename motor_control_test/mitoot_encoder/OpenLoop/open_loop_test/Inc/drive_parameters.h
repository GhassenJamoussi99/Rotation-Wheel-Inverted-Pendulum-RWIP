...
#define MAX_APPLICATION_SPEED_RPM       7536 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT         643
#define PID_TORQUE_KI_DEFAULT         321
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           643
#define PID_FLUX_KI_DEFAULT           321
...
#define PID_SPEED_KP_DEFAULT          2438/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          321/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
/* Phase 2 */
#define PHASE2_DURATION                2964 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (1482*SPEED_UNIT/_RPM)
#define PHASE2_FINAL_CURRENT           10026
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (1482*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           10026
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (1482*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           10026
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (1482*SPEED_UNIT/_RPM)
...
#define OBS_MINIMUM_SPEED_RPM          1334
